...
class DotsIndicator : LinearLayout {
    ...
    private var mIndicatorBackgroundResId = R.drawable.ic_dot_selected_briefing_screen
    private var mIndicatorUnselectedBackgroundResId = R.drawable.ic_dot_unselected_briefing_screen
    ...
    private fun handleTypedArray(context: Context, attrs: AttributeSet?) {
        ...
        mIndicatorBackgroundResId = typedArray.getResourceId(
            ...
            R.drawable.ic_dot_selected_briefing_screen
        )
    ...
    private fun checkIndicatorConfig() {
        ...
        mIndicatorBackgroundResId =
            if (mIndicatorBackgroundResId == 0) R.drawable.ic_dot_unselected_briefing_screen else mIndicatorBackgroundResId
        mIndicatorUnselectedBackgroundResId =
